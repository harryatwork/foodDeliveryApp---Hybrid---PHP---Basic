    ...
    <div class=""style="width:auto">
      <div class="head p-3">
        ...
        <div
          ...
          style="border: 2px solid black; width:460px; height: 580px; background-color:lightblue; border-radius: 20px;margin-left:400px;"
        >
          <div class="col-md-8 py-3">
            <center>
              <img src="images/mainpage/logo.png" alt="" width="300px;" />
              <h5>Sign Up to Become a Delivery Associate</h5>
              <p style="font-size:13px;">Groceries Delivered In 1 Hour! </p>
            </center>
        <form action="dasignupinsert.php" method="post">
            <input
              type="text"
            ...
            <select class="form-control mb-2"  style="border-radius: 20px" required name="vehicle">
                <option value="" >Select Vehicle</option>
                <option value="Bi Cycle" >Bi-Cycle</option>
