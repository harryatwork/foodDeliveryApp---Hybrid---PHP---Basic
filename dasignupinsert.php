...
if ($conn->connect_error) {
	die("Connection failed: " . $conn->connect_error);
            ...
            $sql="select * from da where (email='$email');";
            ...
            $sql2 = "INSERT INTO da (fname, lname, mobile, email, password, city, status, vehicle, date)
			VALUES ('$fname', '$lname', '$mobile', '$email', '$password', '$city', '$status', '$vehicle', '$date2')";
