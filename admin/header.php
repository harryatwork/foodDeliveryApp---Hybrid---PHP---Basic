        ...
        <div class="sidebar">
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
					...
					<li class="">
                        <a href="vendors" style="color:white;">
                            <i class="material-icons" style="color:white;">dashboard</i>
                            <p>Vendors</p>
                        </a>
                    </li>
					<!--
					<li class="">
                        <a href="subadmins" style="color:white;">
                            <i class="material-icons" style="color:white;">dashboard</i>
                            <p>Sub Admins</p>
                        </a>
                    </li>
					...
					<!--
					<li class="">
                        <a href="coupons" style="color:white;">
                            <i class="material-icons" style="color:white;">dashboard</i>
                            <p>Coupons</p>
                        </a>
                    </li>
					<li>
					<li class="">
                        <a href="visits" style="color:white;">
                            <i class="material-icons" style="color:white;">dashboard</i>
                            <p>Visits</p>
                        </a>
                    </li>
					...
					<li>
                        ...
                        <div class="collapse" id="tabless" aria-expanded="false" style="height: 0px;">
                            <ul class="nav">
                                <li><a href="sliders" style="color:white;">Sliders</a></li>
								<li><a href="category" style="color:white;">Catagories</a></li>
								<li><a href="others" style="color:white;">Other Settings</a></li>
                            </ul>
                        </div>
                    </li>
